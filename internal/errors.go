...
var (
	...
	ErrViewOrderOutOfRange = errors.New("view order is out of range")
...
func ErrorHandler(err error) problem.Problem {
	...
	case errors.Is(err, ErrViewOrderOutOfRange):
		return problem.NewBadRequestProblem("view order is out of range")
