...
func (_e *MockStore_Expecter) Count(ctx any, userID any, filter any) *MockStore_Count_Call {
...
//   - id uuid.UUID
//   - userID uuid.UUID
func (_e *MockStore_Expecter) Get(ctx any, id any, userID any) *MockStore_Get_Call {
...
//   - page int
//   - size int
func (_e *MockStore_Expecter) List(ctx any, userID any, filter any, page any, size any) *MockStore_List_Call {
...
func (_e *MockStore_Expecter) Update(ctx any, id any, userID any, arg any) *MockStore_Update_Call {
